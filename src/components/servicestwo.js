...
function Services() {
  ...
  return (
   <Layout>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-lg-5 col-md-9 md-margin-7-rem-bottom">
                        <span class="alt-font margin-20px-bottom text-gradient-sky-blue-pink d-inline-block text-uppercase font-weight-500 letter-spacing-1px">Experience agency</span>
                        <h4 class="alt-font font-weight-600 text-extra-dark-gray w-95">We help our clients build value digital web solutions</h4>
                        <p class="w-80 lg-w-95">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua printing typesetting.</p>
                        <a href="#services" class="btn btn-medium btn-dark-gray margin-15px-top btn-round-edge section-link">Our services<i class="feather icon-feather-arrow-right icon-very-small right-icon"></i></a>
                    </div>
                    <div class="col-12 col-lg-7 col-md-9 padding-55px-lr md-padding-5px-left sm-padding-50px-right">
                        <figure class="image-back-offset-shadow position-right w-100">
                            <img class="border-radius-6px" src="https://lithohtml.themezaa.com/images/our-services-01.jpg" alt=""/>
        ...
        {/* <!-- end section -->
        <!-- start section --> */}
        <section class="parallax overflow-visible wow animate__fadeIn" id="services" data-parallax-background-ratio="0.1" style={{backgroundImage: "url('https://lithohtml.themezaa.com/images/our-services-17.png')"}}>
            <div class="container">  
                <div class="row">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="border-all border-width-1px border-color-medium-gray border-radius-4px overflow-hidden margin-5px-right xs-no-margin-right">
                                                <div class="row g-0 row-cols-1 row-cols-sm-2">
                                                    <div class="col cover-background xs-h-250px" style={{backgroundImage: "url('	https://lithohtml.themezaa.com/images/our-story-img11.jpg')"}}></div>
                                                    <div class="col">
                ...
                <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center margin-9-rem-bottom lg-margin-7-rem-bottom">
                    ...
                    <div class="col md-margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                        <div class="testimonials-style-02 border-radius-5px overflow-hidden">
                            <img alt="" class="d-inline-block" src="https://lithohtml.themezaa.com/images/testimonial-img-09.jpg"/>
                    ...
                    <div class="col md-margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                        <div class="testimonials-style-02 border-radius-5px overflow-hidden">
                            <img alt="" class="d-inline-block" src="https://lithohtml.themezaa.com/images/testimonial-img-10.jpg"/>
                            <div class="testimonials-content padding-3-half-rem-all text-center bg-white lg-padding-2-half-rem-lr">
                                <div class="testimonials-rounded-icon bg-white rounded-circle">
                                    <i class="fa fa-quote-left icon-small text-gradient-light-purple-light-orange"></i>
                                </div>
                    ...
                    <div class="col wow animate__fadeIn" data-wow-delay="0.6s">
                        <div class="testimonials-style-02 border-radius-5px overflow-hidden">
                            <img alt="" class="d-inline-block" src="https://lithohtml.themezaa.com/images/testimonial-img-11.jpg"/>
                            <div class="testimonials-content padding-3-half-rem-all text-center bg-white lg-padding-2-half-rem-lr">
                                <div class="testimonials-rounded-icon bg-white rounded-circle">
                                    <i class="fa fa-quote-left icon-small text-gradient-light-purple-light-orange"></i>
                                </div>
                ...
                <div class="row row-cols-1 row-cols-lg-6 row-cols-md-3 row-cols-sm-2 client-logo-style-04">
                    ...
                    <div class="col text-center sm-no-margin wow animate__fadeIn">
                        <div class="client-box padding-25px-all text-center">
                            <a href="#"><img alt="clients logo 01" src="https://lithohtml.themezaa.com/images/clients-logo-01.png"/></a>
                    ...
                    <div class="col text-center sm-no-margin wow animate__fadeIn">
                        <div class="client-box padding-25px-all text-center">
                            <a href="#"><img alt="clients logo 01" src="https://lithohtml.themezaa.com/images/clients-logo-02.png"/></a>
                            <span class="client-overlay bg-white box-shadow-small border-radius-4px"></span>
                        </div>
                    </div>
                    {/* <!-- end client item -->
                    ...
                    <div class="col text-center sm-no-margin wow animate__fadeIn">
                        <div class="client-box padding-25px-all text-center">
                            <a href="#"><img alt="clients logo 01" src="https://lithohtml.themezaa.com/images/clients-logo-03.png"/></a>
                            <span class="client-overlay bg-white box-shadow-small border-radius-4px"></span>
                        </div>
                    </div>
                    {/* <!-- end client item -->
                    ...
                    <div class="col text-center sm-no-margin wow animate__fadeIn">
                        <div class="client-box padding-25px-all text-center">
                            <a href="#"><img alt="clients logo 01" src="https://lithohtml.themezaa.com/images/clients-logo-04.png"/></a>
                            <span class="client-overlay bg-white box-shadow-small border-radius-4px"></span>
                        </div>
                    </div>
                    {/* <!-- end client item -->
                    ...
                    <div class="col text-center sm-no-margin wow animate__fadeIn">
                        <div class="client-box padding-25px-all text-center">
                            <a href="#"><img alt="clients logo 01" src="https://lithohtml.themezaa.com/images/clients-logo-05.png"/></a>
                            <span class="client-overlay bg-white box-shadow-small border-radius-4px"></span>
                        </div>
                    </div>
                    {/* <!-- end client item -->
                    ...
                    <div class="col text-center sm-no-margin wow animate__fadeIn">
                        <div class="client-box padding-25px-all text-center">
                            <a href="#"><img alt="clients logo 01" src="https://lithohtml.themezaa.com/images/clients-logo-06.png"/></a>
                            <span class="client-overlay bg-white box-shadow-small border-radius-4px"></span>
                        </div>
                    </div>
                    {/* <!-- end client item --> */}
