						                    ...
						                    <div class="wpb_wrapper">
						                        <div class="wpb_single_image wpb_content_element align_center">
						                            <figure class="wpb_wrapper figure">
						                                <div class="single_image-wrapper box_border_grey"><img src="http://templates.thememodern.com/consultax/images/contact.jpg" class="single_image-img attachment-full" alt=""/></div>
						                            </figure>
						                        </div>
						                    </div>
						                </div>
